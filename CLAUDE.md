...
**Immediate next step (2026-06-26):** apply migrations `20260720`–`20260723` to staging then prod after merge (Spec 1 forecast/dashboard-actions: `20260720`/`20260721`; Spec 2 recurring series: `20260722`/`20260723`), smoke each tier. Then Spec 3: group-scope cash position (live + forecast together). Deferred: dashboard slice 2 (`debt_detected`, planning-queue surplus/debt_due), field-scoped search, AI/Capacitor prep.
