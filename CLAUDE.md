...
**Immediate next step (2026-06-26):** commit Spec 1 (commit list below), then open PR for the separated forecast/recurrence + dashboard-actions + Spec 1 commits, apply migrations `20260720`/`20260721` after merge. Then Spec 2 (recurring series management) per the design fork (series actions on any row). Deferred: dashboard slice 2 (`debt_detected`, planning-queue surplus/debt_due), field-scoped search, AI/Capacitor prep.
