...
**Immediate next step (2026-06-24):** open PR for the separated forecast/recurrence and dashboard-actions commits, apply migrations `20260720` and `20260721` after merge, then wire slice 2 (`debt_detected`, planning-queue surplus/debt_due). Other deferred tracks: field-scoped transaction search, AI/Capacitor codebase-prep cleanup.
