...
**Bank CSV import V1:** steps 1–5.5 done (see history). **Step 6 backlog** — save-as-rule + categorization rules engine + masked LLM `suggested_category`. Dashboard AI observability ("Sygnały z okresu") parked 2026-05-24 until core product stable.
