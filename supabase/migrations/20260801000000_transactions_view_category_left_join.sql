-- Keep shared transactions visible even when the viewer cannot read the
-- transaction owner's private category row.
...
comment on view public.transactions_with_category is
  'Transactions enriched with caller-visible category data and import hold state. Private categories fall back without hiding shared transactions.';
