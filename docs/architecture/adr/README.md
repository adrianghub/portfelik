...
| [0010](./0010-shared-cf-pages-shared-supabase-staging.md) | Shared Cloudflare Pages project + shared Supabase project for prod & staging | Superseded |
| [0011](./0011-dedicated-supabase-staging-project.md)      | Dedicated Supabase project for staging                                       | Accepted   |
