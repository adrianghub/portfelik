...
<EmptyState title={m.dashboard_discovery_title()} body={m.dashboard_discovery_body()}>
  ...
  {#snippet action()}
    <div class="flex flex-col items-center justify-center gap-2 sm:flex-row">
      ...
      <a
        href="/import"
        class="focus-visible:ring-accent inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-4 py-2.5 text-sm font-medium text-slate-200 hover:bg-white/5 focus-visible:ring-2 focus-visible:outline-none"
      >
