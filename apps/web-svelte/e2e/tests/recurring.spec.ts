...
test.describe("recurring entry links", () => {
  ...
  test("transactions header Nadchodzące link opens upcoming transactions view", async ({
    page,
  }) => {
  ...
  test("dashboard keeps recurring count and one link to upcoming transactions", async ({
    page,
  }) => {
